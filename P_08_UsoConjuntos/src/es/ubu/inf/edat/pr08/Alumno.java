...
public class Alumno {
	...
	/**
	 * Metodo que permite añadir de forma sencilla una nueva nota
	 * a la evaluación del alumno. Actualiza también el número de 
	 * pruebas realizadas.
	 * 
	 ...
	 * media aritmética de las notas obtenidas en todas las
	 * pruebas
	 * 
