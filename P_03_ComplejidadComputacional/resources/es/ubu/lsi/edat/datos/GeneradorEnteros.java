...
public class GeneradorEnteros {
	...
	/**
	 * Devuelve una lista de numeros aleatorios. Los numeros perteneceran siempre al
	 * rango delimitado por los limites inferior y superior.
	 * 
	 * @param tamano
	 * @param inferior
	 * @param superior
	...
	/**
	 * Genera una lista aleatoria seleccionando solo de entre los elementos
	 * indicados en la lista pasada como parametro.
	 * 
	 * @param tamano
